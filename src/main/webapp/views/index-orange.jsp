          ...
          <div class="row">
            <nav class="templatemo-top-nav col-lg-12 col-md-12">
              <ul class="text-uppercase">
                <li><a href="index"  >红色预警</a></li>
                <li><a href="index-orange "  class="active">橙色预警</a></li>
          ...
          <div class="templatemo-content-widget no-padding">
			...
			if(pageNum<=5){
				if(currentPage ==1){
					...
					document.write("<div class=\"joggerOrange\"><span class=\"disabled\"> < </span><span class=\"current\">1</span>");
				
				}
				else{
					var page1=currentPage-1;
					document.write("<div class=\"joggerOrange\"><a href=\"?page="+page1+"\"> < </a><a href=\"?page=1\">1</a>");
			...
			if(currentPage ==1){
					...
					document.write("<div class=\"joggerOrange\"><a href=\"?page="+$currentPage-1+"\"> < </a><a href=\"?page=1\">1</a>");
