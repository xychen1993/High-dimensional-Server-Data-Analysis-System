...
public class ShowAlertService {
    ...
    public String getCountShow(String paramStr) throws ClassNotFoundException, Exception{
		...
		Connection connection= DriverManager.getConnection("jdbc:mondrian:" + 
				        		"Jdbc=jdbc:mysql://advert9004.db.d.xiaonei.com:3306/im_logmonitor_test; JdbcUser=rr_oper@XN; JdbcPassword=DE7C5B83A66@XN;" +
				        		"Catalog=/root/apache-tomcat-7.0.63/webapps/dataCube.xml;"+"JdbcDrivers=com.mysql.jdbc.Driver;");
   ...
   // 	Connection connection=DriverManager.getConnection("Provider=mondrian; Jdbc=jdbc:mysql://10.4.36.39:3306/im_logmonitor_test; JdbcUser=rr_oper@XN; JdbcPassword=DE7C5B83A66@XN; Catalog=file:////root/apache-tomcat-7.0.63/webapps/dataCube.xml; JdbcDriver=com.mysql.jdbc.Driver",null);

  /*
   * Connection connection= DriverManager.getConnection("jdbc:mondrian:" + "Jdbc=jdbc:mysql://advert9004.db.d.xiaonei.com:3306/im_logmonitor_test; JdbcUser=rr_oper@XN; JdbcPassword=DE7C5B83A66@XN;" +
				        		"Catalog=/root/apache-tomcat-7.0.63/webapps/dataCube.xml;"+"JdbcDrivers=com.mysql.jdbc.Driver");
