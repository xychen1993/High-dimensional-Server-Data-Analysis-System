  ...
  <body>  
      ...
      <div class="templatemo-sidebar">
        ...
        <nav class="templatemo-left-nav">          
          ...
          <li><a  href="index" ><i class="fa fa-home fa-fw"></i>监控警报</a></li>
            <li><a href="avg-time" class="active"><i class="fa fa-database fa-fw"></i>平均时长</a></li>
          ...
          <div class="templatemo-content-widget no-padding">
            <div class="panel panel-default table-responsive" style="height:700px;width:800">
				...
				<select id="tagSelect" style="margin-top:-34px;margin-left:33%;" class="form-control">
                          ...
                          <input type="text" placeholder="月"  style="margin-top:-34px;margin-left:55%;width:5%" class="form-control" id="month" onfocus="WdatePicker({dateFmt:'MM'})" />
    ...
    <script type="text/javascript">
		...
		function get() {
		 ...
		 window.location.href="avg-time?serviceId="+serviceId+"&endPoint="+endPoint+"&tag="+tag+"&year1="+year+"&month1="+month+"&day1="+day+"&hour1="+hour+"&minute1="+minute;
		}      
